...
namespace ModernMod
{
    public partial class WorldBoxMod : MonoBehaviour
    {
        ...
        {   
            ...
            //addUpgrade("house_human_5", 500, 500, 1000, true, 0);
            human.addUpgrade("house_human_5", 0, 0, 50, 0, false, false, 0);
                //HUMAN
            ...
            human.addUpgrade("hall_human_2", pPop: 100, pBuildings: 20);
            ...
            orc.addUpgrade("hall_orc_2", pPop: 100, pBuildings: 20);
            ...
            elf.addUpgrade("hall_elf_2", pPop: 100, pBuildings: 20);
            ...
            dwarf.addUpgrade("house_dwarf_5");
            ...
            dwarf.addUpgrade("hall_dwarf_2", pPop: 100, pBuildings: 20);
